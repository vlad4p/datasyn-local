...
-- Uso: uv run python scripts/python/db.py run-sql --file scripts/sql/sociavault/ingest_sociavault_instagram.sql
...
CREATE OR REPLACE TABLE bronze.sv_ig_post_selected AS
