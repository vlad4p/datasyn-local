-- Build silver.network_profile from legacy Facebook (fb_*) tables only.
-- Twitter/X lives in the twikit pipeline (silver.tk_tw_*). twitter_* columns
-- are kept as NULL for backward-compatible schema with gold.v_entidades*.
...
-- Classified-comment activity per author (Facebook only)
...
SELECT
    ...
    p.facebook_user_url,
    CAST(NULL AS VARCHAR) AS twitter_user_id,
    CAST(NULL AS VARCHAR) AS twitter_username,
    CAST(NULL AS VARCHAR) AS twitter_profile_url,
    a.instagram_id,
    ...
    a.first_seen,
    a.last_seen,
    -- Twitter/X columns retired (twikit pipeline owns Twitter)
    CAST(NULL AS VARCHAR) AS twitter_display_name,
    CAST(NULL AS VARCHAR) AS twitter_bio,
    CAST(NULL AS VARCHAR) AS twitter_location,
    CAST(NULL AS BIGINT) AS twitter_followers_count,
    CAST(NULL AS BIGINT) AS twitter_following_count,
    CAST(NULL AS BIGINT) AS twitter_statuses_count,
    CAST(NULL AS BIGINT) AS twitter_listed_count,
    CAST(NULL AS BIGINT) AS twitter_media_count,
    CAST(NULL AS BIGINT) AS twitter_favourites_count,
    CAST(NULL AS BOOLEAN) AS twitter_is_blue_verified,
    CAST(NULL AS TIMESTAMPTZ) AS twitter_account_created_at,
    CAST(NULL AS VARCHAR) AS twitter_profile_image_url,
    CAST(NULL AS TIMESTAMP) AS twitter_profile_snapshot_at,
