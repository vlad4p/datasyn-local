...
Usage:
    uv run python scripts/python/classify/classify_sv_comments.py --platform facebook --limit 100
    uv run python scripts/python/classify/classify_sv_comments.py --platform all --limit 500 --dry-run
...
def _ensure_schema(con) -> None:
    sql_path = db.resolve_sql("ingest_sociavault_classification.sql")
