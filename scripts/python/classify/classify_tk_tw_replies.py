...
Usage:
    ...
    uv run python scripts/python/classify/classify_tk_tw_replies.py --cluster-apoyo
...
SQL_CLASS = db.resolve_sql("ingest_tk_tw_classification.sql")
SQL_GOLD = db.resolve_sql("ingest_tk_hater_narrativa.sql")
SQL_GOLD_APOYO = db.resolve_sql("ingest_tk_apoyo_narrativa.sql")
