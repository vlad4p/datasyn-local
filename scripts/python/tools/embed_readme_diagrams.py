...
Usage (repo root):
  uv run python scripts/python/tools/embed_readme_diagrams.py README.md README.es.md
"""
...
```bash
uv run python scripts/python/tools/embed_readme_diagrams.py README.md
```"""
    new = (
