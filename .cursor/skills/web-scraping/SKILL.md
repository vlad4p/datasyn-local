...
## Template script (save to `src/scrape_example.py`)
...
from src.db import get_landing_path
...
```bash
make ingest FILE=data/landing/source_20250602.json TABLE=source_articles
```
