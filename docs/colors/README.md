...
The five README diagrams live in [`../diagrams/`](../diagrams/) — edit the `.svg` files; the README references them with `<img src="docs/diagrams/…">`. See [`../diagrams/README.md`](../diagrams/README.md) for inventory and FigJam source.
