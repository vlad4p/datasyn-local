...
- [`graph-analysis`](../graph-analysis/SKILL.md) — network reports → `report/grafo/`
- [`sentiment-analysis`](../sentiment-analysis/SKILL.md) — text tone → `report/<project>/`
- [`interactive-graph-reports`](../interactive-graph-reports/SKILL.md) — HTML graphs → `report/<project>/`
