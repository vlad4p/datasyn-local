...
- Legacy CSV dumps in `data/landing/redes/data-fb/` are a **separate** pipeline — see [`ingest/references/redes-legacy-csv.md`](../../../ingest/references/redes-legacy-csv.md)

## Related

- Pipeline entry: [`scrape-sociavault`](../scrape-sociavault/SKILL.md)
- [`ingest-data-gold`](../../../ingest/gold/ingest-data-gold/SKILL.md) · [`graph-ingest`](../../../analyze/graph/graph-ingest/SKILL.md)
