...
| Gold redes | `gold.v_*`, `gold.grafo_*` | [`redes-gold`](gold/redes-gold/SKILL.md) |
...
After gold → use [`statistical-report`](../analyze/reports/statistical-report/SKILL.md), [`redes-analysis`](../analyze/reports/redes-analysis/SKILL.md), or other analyze skills.
