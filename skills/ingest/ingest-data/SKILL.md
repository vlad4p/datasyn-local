...
|------|--------|---------|--------|-------|
| 🟤 **Bronze** | `bronze.*` | Raw ingest, preserve originals | `data/landing/` files, scrapes | [`ingest-data-bronze`](../bronze/ingest-data-bronze/SKILL.md) |
| ⚪ **Silver** | `silver.*` | Clean, dedupe, normalize, join | `bronze.*` tables | [`ingest-data-silver`](../silver/ingest-data-silver/SKILL.md) |
| 🟡 **Gold** | `gold.*` | Aggregated, analysis‑ready datasets | `silver.*` tables | [`ingest-data-gold`](../gold/ingest-data-gold/SKILL.md) |
